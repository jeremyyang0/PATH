...
import { PathFileTreeFeature, WorkspaceTreeFeatureDependencies } from '../models/contracts';
...
export function registerPathFileTreeFeature(
    context: vscode.ExtensionContext,
    dependencies: WorkspaceTreeFeatureDependencies
): PathFileTreeFeature {
    ...
    const commandService = new PathFileTreeCommandService(dataProvider, treeView, {
        loadZentaoCaseById: dependencies.loadZentaoCaseById
    });
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('pathFileTree.createCase', async (element?: TreeItem | vscode.Uri) => {
